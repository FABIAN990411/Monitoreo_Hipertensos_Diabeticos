...
if(!empty($_POST["doctor"])) 
{
 ...
 $sql=mysqli_query($con,"select horario from doctors where id='".$_POST['doctor']."'");
 while($row=mysqli_fetch_array($sql))
 	{?>
 <option value="<?php echo htmlentities($row['horario']); ?>"><?php echo htmlentities($row['horario']); ?></option>
  <?php
}
}

...
if (isset($_POST['submit'])) {
	...
	if ($query) {
		echo "<script>alert('El usuario se ha registrado con éxito. Ya puede iniciar sesión');</script>";
...
<head>
	<title>Usuario | crear cuenta</title>
			...
			<div class="box-register">
				<form name="registration" id="registration" method="post" onSubmit="return valid();">
					<fieldset>
						...
						<p>
							A continuación digité sus datos personales:
						</p>
						...
						<p>
							A continuación digité los datos de su cuenta:
						</p>
						<div class="form-group">
						...
						<div class="form-actions">
							...
							<button type="submit" class="btn btn-orange pull-right" id="submit" name="submit" >

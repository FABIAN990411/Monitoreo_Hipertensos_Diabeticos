...
if (isset($_POST['submit'])) {
	...
	$query = mysqli_query($con, "insert into users(fullname,address,city,gender,email) values('$fname','$address','$city','$gender','$email')");
	if ($query) {
		echo "<script>alert('el usuario se ha registrado con éxito.');</script>";

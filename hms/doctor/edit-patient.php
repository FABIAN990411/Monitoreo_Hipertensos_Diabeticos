...
if (isset($_POST['submit'])) {
	...
	$sql = mysqli_query($con, "update tblpatient set PatientName='$patname',PatientContno='$patcontact',PatientEmail='$patemail',PatientGender='$gender',PatientAdd='$pataddress',PatientAge='$patage',PatientMedhis='$medhis',Numeroid ='$idoc ' where ID='$eid'");
	if ($sql) {
...
<head>
	<title>MÉDICO | EDIT.PACIENTE</title>
			...
			<div class="main-content">
				<div class="wrap-content container" id="container">
					...
					<section id="page-title">
						<div class="row">
							<div class="col-sm-8">
								<h1 class="mainTitle">Médico | Editar datos del paciente</h1>
							</div>
									...
									<div class="col-lg-8 col-md-12">
										<div class="panel panel-white">
											<div class="panel-heading">
												<h5 class="panel-title">FORMULARIO EDITAR PACIENTE</h5>
											</div>
												...
												<form role="form" name="" method="post">
													...
													?>
														...
														<div class="form-group">
															...
															<input type="text" name="idoc" class="form-control" value="<?php echo $row['Numeroid']; ?>" required="true">
														</div>
														<div class="form-group">
															<label for="doctorname">
																NOMBRE
														...
														<div class="form-group">
															...
															<?php if ($row['gender'] == "Female") { ?>
																<input type="radio" name="gender" id="rg-female" value="Female" checked="true">Femenino
																<input type="radio" name="gender" id="rg-male" value="male">Masculino
															<?php } else { ?>
																<label>
																	<input type="radio" name="gender" id="rg-male" value="Male" checked="true">Masculino
																	<input type="radio" name="gender" id="rg-female" value="Female">Femenino
																</label>
															<?php } ?>
														</div>
														<div class="form-group">

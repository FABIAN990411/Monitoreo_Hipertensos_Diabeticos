...
<head>
	<title>Médico |Recuperar contraseña</title>
	...
	<div class="row">
		<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
			<div class="logo margin-top-30">
				<a href="../../index.php">
					<h4> Médico |Recuperar contraseña </h4>
				</a>
			</div>
					...
					<fieldset>
						...
						<div class="form-group form-actions">
							...
							<span class="input-icon">
								<input type="text" class="form-control" name="contactno" placeholder="Número de telefono del médico registrado">
						...
						<div class="form-group">
							...
							<span class="input-icon">
								<input type="email" class="form-control" name="email" placeholder="Correo electrónico del médico registrado">
